...
const CAMELOT_CHRONICLE = [
  { status:'officiel', badge:'Confirmé', title:"Blizzard aborde l'avenir de Classic à la BlizzCon", text:"Lors du State of Azeroth du 29 janvier 2026, la productrice exécutive Holly Longdale a évoqué de « nouveaux projets Classic » avant de renvoyer tous les détails à la BlizzCon 2026 (12-13 septembre, Anaheim). C'est la seule communication officielle à ce jour sur le sujet.", source:'https://misti.services/blog/wow-classic-plus-leak' },
  ...
  { status:'datamine', badge:'Datamine', title:'Le build quitte les serveurs internes', text:"Fin juillet 2026, des trackers communautaires signalent que le build « Camelot » (patch 1.60) est passé sur un serveur accessible aux partenaires externes de Blizzard — un signe que le projet sort de la phase de test purement interne, sans que ça garantisse une annonce imminente.", source:'https://www.creocommunity.com/world-of-warcraft/wow-classic-projet-camelot-progresse-alors-que-blizzard-devoile-une-version-inedite/' },
  ...
  { status:'rumeur', badge:'Rumeur (faible fiabilité)', title:'Date de sortie « fuitée » : 13 octobre 2026', text:"Une publication anonyme sur un forum communautaire avance cette date. Aucun recoupement sérieux ne la confirme — à prendre avec de grosses pincettes.", source:'https://misti.services/blog/wow-classic-plus-leak' },
  { status:'rumeur', badge:'Rumeur', title:'Nouvelles races : Hauts-Elfes et Trolls Amani', text:"Des leaks évoquent les Hauts-Elfes pour l'Alliance et les Trolls Amani pour la Horde, avec zones et capitales dédiées, plus des sous-races (Elfes Voyageurs du Temps, Elfes des Hautes-Terres) et des combos inédits comme Tauren Paladin ou Nain Chaman. Rien d'officiel.", source:'https://frostyboost.com/blog/wow-classic-plus-new-races-seasonal-resets-and-class-reworks' },
  { status:'rumeur', badge:'Rumeur (faible fiabilité)', title:"D'anciens donjons transformés en raids ?", text:"Un compte créé en juin 2026 sur un forum communautaire prétend que les Mortes-Mines et le Gouffre de Ragefeu deviendraient des raids, aux côtés de la Monastère Écarlate, des Profondeurs de Rochenoire et de Blackwing Lair. Le Cœur du Magma redeviendrait un simple donjon, Ragnaros purement retiré. Aucune preuve technique ne soutient cette rumeur — à traiter comme une pure spéculation de forum.", source:'https://kami-labs.fr/wow-classic/wow-classic-plus-blizzcon-2026/' },
  { status:'officiel', badge:'À noter', title:"Toujours aucune annonce officielle de « Classic+ »", text:"Blizzard n'a jamais prononcé publiquement le mot « Classic+ ». Tout ce qui précède — dates, classes, races, format — reste construit à partir de datamining et de rumeurs communautaires, pas d'une annonce.", source:'https://misti.services/blog/wow-classic-plus-guide-blizzcon-2026' },
];
...
function renderChroniqueHtml(){
  ...
  `).join('');
  return `<div class="chron-disclaimer">⚠️ Dernière mise à jour : 10 septembre 2026. Tout ce qui suit reflète l'état des rumeurs avant la BlizzCon 2026 — classé par niveau de fiabilité (Confirmé / Datamine / Rumeur). Cette page sera mise à jour après l'événement avec les annonces réelles.</div>${cards}`;
}
